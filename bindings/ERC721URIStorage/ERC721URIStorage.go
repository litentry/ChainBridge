...
// ERC721URIStorageBatchMetadataUpdateIterator is returned from FilterBatchMetadataUpdate and is used to iterate over the raw logs and unpacked data for BatchMetadataUpdate events raised by the ERC721URIStorage contract.
type ERC721URIStorageBatchMetadataUpdateIterator struct {
	Event *ERC721URIStorageBatchMetadataUpdate // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC721URIStorageBatchMetadataUpdateIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC721URIStorageBatchMetadataUpdate)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC721URIStorageBatchMetadataUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC721URIStorageBatchMetadataUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_ERC721URIStorage *ERC721URIStorageFilterer) FilterBatchMetadataUpdate(opts *bind.FilterOpts) (*ERC721URIStorageBatchMetadataUpdateIterator, error) {

	logs, sub, err := _ERC721URIStorage.contract.FilterLogs(opts, "BatchMetadataUpdate")
	if err != nil {
		return nil, err
	}
	return &ERC721URIStorageBatchMetadataUpdateIterator{contract: _ERC721URIStorage.contract, event: "BatchMetadataUpdate", logs: logs, sub: sub}, nil
}

// WatchBatchMetadataUpdate is a free log subscription operation binding the contract event 0x6bd5c950a8d8df17f772f5af37cb3655737899cbf903264b9795592da439661c.
//
// Solidity: event BatchMetadataUpdate(uint256 _fromTokenId, uint256 _toTokenId)
func (_ERC721URIStorage *ERC721URIStorageFilterer) WatchBatchMetadataUpdate(opts *bind.WatchOpts, sink chan<- *ERC721URIStorageBatchMetadataUpdate) (event.Subscription, error) {

	logs, sub, err := _ERC721URIStorage.contract.WatchLogs(opts, "BatchMetadataUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC721URIStorageBatchMetadataUpdate)
				if err := _ERC721URIStorage.contract.UnpackLog(event, "BatchMetadataUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BatchMetadataUpdate(uint256 _fromTokenId, uint256 _toTokenId)
func (_ERC721URIStorage *ERC721URIStorageFilterer) ParseBatchMetadataUpdate(log types.Log) (*ERC721URIStorageBatchMetadataUpdate, error) {
	event := new(ERC721URIStorageBatchMetadataUpdate)
	if err := _ERC721URIStorage.contract.UnpackLog(event, "BatchMetadataUpdate", log); err != nil {
		return nil, err
	}
...
// ERC721URIStorageMetadataUpdateIterator is returned from FilterMetadataUpdate and is used to iterate over the raw logs and unpacked data for MetadataUpdate events raised by the ERC721URIStorage contract.
type ERC721URIStorageMetadataUpdateIterator struct {
	Event *ERC721URIStorageMetadataUpdate // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC721URIStorageMetadataUpdateIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC721URIStorageMetadataUpdate)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC721URIStorageMetadataUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC721URIStorageMetadataUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_ERC721URIStorage *ERC721URIStorageFilterer) FilterMetadataUpdate(opts *bind.FilterOpts) (*ERC721URIStorageMetadataUpdateIterator, error) {

	logs, sub, err := _ERC721URIStorage.contract.FilterLogs(opts, "MetadataUpdate")
	if err != nil {
		return nil, err
	}
	return &ERC721URIStorageMetadataUpdateIterator{contract: _ERC721URIStorage.contract, event: "MetadataUpdate", logs: logs, sub: sub}, nil
}

// WatchMetadataUpdate is a free log subscription operation binding the contract event 0xf8e1a15aba9398e019f0b49df1a4fde98ee17ae345cb5f6b5e2c27f5033e8ce7.
//
// Solidity: event MetadataUpdate(uint256 _tokenId)
func (_ERC721URIStorage *ERC721URIStorageFilterer) WatchMetadataUpdate(opts *bind.WatchOpts, sink chan<- *ERC721URIStorageMetadataUpdate) (event.Subscription, error) {

	logs, sub, err := _ERC721URIStorage.contract.WatchLogs(opts, "MetadataUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC721URIStorageMetadataUpdate)
				if err := _ERC721URIStorage.contract.UnpackLog(event, "MetadataUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MetadataUpdate(uint256 _tokenId)
func (_ERC721URIStorage *ERC721URIStorageFilterer) ParseMetadataUpdate(log types.Log) (*ERC721URIStorageMetadataUpdate, error) {
	event := new(ERC721URIStorageMetadataUpdate)
	if err := _ERC721URIStorage.contract.UnpackLog(event, "MetadataUpdate", log); err != nil {
		return nil, err
	}
