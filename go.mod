...
require (
	...
	github.com/Phala-Network/chainbridge-substrate-events v0.0.0-20210818082942-6fc10a0154c5 // indirect
	github.com/Phala-Network/chainbridge-utils v1.0.7-0.20210818083108-f2b3dcf9fcd6 // indirect
